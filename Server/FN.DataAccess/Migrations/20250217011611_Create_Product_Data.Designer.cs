...
namespace FN.DataAccess.Migrations
{
    ...
    [Migration("20250217011611_Create_Product_Data")]
    partial class Create_Product_Data
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FN.DataAccess.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("TimeCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 2, 17, 8, 16, 10, 605, DateTimeKind.Local).AddTicks(8730));
            ...
            modelBuilder.Entity("FN.DataAccess.Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 2, 17, 1, 16, 10, 606, DateTimeKind.Utc).AddTicks(3300));

                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 2, 17, 1, 16, 10, 606, DateTimeKind.Utc).AddTicks(3779));
            ...
            modelBuilder.Entity("FN.DataAccess.Entities.ProductPrice", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 2, 17, 1, 16, 10, 608, DateTimeKind.Utc).AddTicks(119));

                    b.Property<DateTime>("EndDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 2, 17, 1, 16, 10, 607, DateTimeKind.Utc).AddTicks(9735));
                    ...
                    b.Property<DateTime>("StartDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 2, 17, 1, 16, 10, 607, DateTimeKind.Utc).AddTicks(9345));
